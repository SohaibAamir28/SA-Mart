...
export default async function page() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 mx-5 md:mx-20 gap-y-10 md:gap-x-20 text-center bg-gradient-to-l from-indigo-300 via-sky-300 to-indigo-300 h-screen hover:from-pink-200 hover:to-green-200 my-400 scroll-m-20">
