...
export function TypographyH1() {
  return (
    <div className="flex p-10 justify-center items-center mx-10 bg-gradient-to-r from-blue-500 to-green-400">
      <div className="p-15">
        <div className="ml-10">
      ...
      <div className="sm:hidden md:hidden lg:flex">
        <div className="bg-gradient-to-r from-green-500 to-blue-400 rounded-full">
