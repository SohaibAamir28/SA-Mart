...
export default function Promote() {
  return (
    <div className="flex flex-col justify-center items-center md:m-10 mt-10 bg-gradient-to-r from-green-400 to-blue-500 ">
      <div >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:p-10 md:bg-gradient-to-r from-green-400 to-blue-500">
        <div className="md:mx-20 ">
            <div className="flex flex-col md:flex-row bg-gradient-to-r from-green-400 to-blue-500 justify-center items-center px-10 py-5 w-[350px] md:w-[600px]">
